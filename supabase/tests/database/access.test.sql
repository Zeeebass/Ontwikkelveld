...
insert into public.player_questions (player_id, period_id, question, answer, created_by)
values ('10000000-0000-4000-8000-000000000001', null, 'Waar kijk je?', 'Over beide schouders.', 'a0000000-0000-4000-8000-000000000001');
...
select results_eq(
  ...
  array[1::bigint],
  'een vraag mag periode-onafhankelijk zijn'
);
select results_eq(
...
select results_eq($$select count(*)::bigint from public.player_questions$$, array[1::bigint], 'Daan ziet alleen eigen vragen');
